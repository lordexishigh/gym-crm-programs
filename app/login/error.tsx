...
/**
 * Staff login error boundary (beta-hardening-001).
 *
 * Catches errors thrown while rendering the `/login` route and shows a friendly
 * message instead of a stack trace. The error is reported for monitoring; the
 * correlation id (Next.js `digest`) is shown so staff can quote it to support.
 */
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-sm flex-col items-center justify-center gap-4 px-4 py-12 text-center">
      ...
      <p className="text-sm text-slate-600">
        We couldn&apos;t load the sign-in page. The error has been logged.
