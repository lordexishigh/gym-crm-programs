...
- **Exposes:** Sign-in / session JWT issuance, Invite-based user provisioning, JWT verification (HS256 shared secret — `SUPABASE_JWT_SECRET`; tokens are verified locally with `jose`, no JWKS round-trip)
